Shader "Unlit/S_UIButton"
{
    Properties
    {
       [PerRendererData] _MainTex ("Sprite Texture", 2D) = "white" {}
        ...
        _UseBorder ("Use Border", Float) = 0
        _UVScale ("UV Scale", Float) = 2
        [PerRendererData] _Button ("Button", Float) = 0
        [PerRendererData] _Selected ("Selected", Float) = 0
    ...
    SubShader
    {
        ...
        CGPROGRAM
            ...
            fixed4 frame(v2f IN)
            {
                ...
                float bord = max(stp.x, stp.y) * float(_UseBorder);
                color += bord_clr * bord;
                ...
                color += btn_color * draw_icon(float(_Button), uvo);
